...
export default function EducationPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight font-headline">Éducation</h1>
        <p className="text-muted-foreground">Développez vos compétences avec nos formations locales.</p>
      </div>
